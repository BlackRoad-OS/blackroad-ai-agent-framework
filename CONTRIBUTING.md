# Contributing to blackroad-ai-agent-framework
...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/blackroad-ai-agent-framework.git
cd blackroad-ai-agent-framework

# Add upstream remote
git remote add upstream https://github.com/BlackRoad-OS/blackroad-ai-agent-framework.git
